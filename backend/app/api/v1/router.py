...
from app.api.v1 import analytics, audit, auth, competition_validation, feedback, health, integrations, lab, languages, models, ops, settings, submissions, transcriptions, translations, workspaces
...
api_router.include_router(competition_validation.router, prefix="/competition/validation", tags=["competition-validation"])
